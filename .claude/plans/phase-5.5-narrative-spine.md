# Phase 5.5.0 — Narrative Spine (APPROVED COPY)

James-approved verbatim 2026-07-19/20 (4-model council, 2 rounds, transcript
...
| Handoff | Approved copy | Status |
|---|---|---|
| S0→S1 | This assembly repeats. Every twelve hours. A condition of existence. | live (unchanged) |
| S1→S2 | The shell closes. The clock continues. | live (unchanged — James's PRE-EXISTING approved beat, kept 2026-07-20 over the council's "This continuity is fractured…" draft; the council was briefed without knowing this slot was filled) |
...
S4→S5 Minimax (3/4); S5→S6 Gemini trimmed by James's ruling (first sentence "The archive is
complete." cut as factually wrong — the experiment is ongoing).

Register: rendered exactly like the existing `.bridging-beat` (centered, subtle gray,
serif). Second person appears in S5→S6 ONLY — a page-wide pin should enforce no "you" in
any earlier beat.
